...
public class AirplaneType {
    ...
    public boolean equals(Object o) {
        if (o instanceof AirplaneType) {
            AirplaneType toCompare = (AirplaneType) o;
            if (this.id == toCompare.id
                    && this.maxCapacityEconomy == toCompare.maxCapacityEconomy
                    && this.maxCapacityBusiness == toCompare.maxCapacityBusiness
                    && this.maxCapacityFirst == toCompare.maxCapacityFirst)
                return true;
